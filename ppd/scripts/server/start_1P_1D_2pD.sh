#!/bin/bash
# ============================================================================
# Start Script for vLLM Configuration: 1P_1D_2pD
#
# Architecture: 1P + 1D + 2pD
# 
#   GPU0: P (port 8100)
#   GPU1: D (port 8200)
#   GPU2: pD (port 8201)
...
LOG_DIR="$PROJECT_DIR/logs/1P_1D_2pD"
SRC_DIR="$PROJECT_DIR/src"
mkdir -p "$LOG_DIR"
rm -f "$LOG_DIR"/*.log 2>/dev/null || true

echo "=============================================="
echo "Starting vLLM Configuration: 1P_1D_2pD"
echo "Architecture: 1P + 1D + 2pD"
echo "=============================================="
...
echo ""
echo "=============================================="
echo "Configuration 1P_1D_2pD ready!"
echo "Architecture: 1P + 1D + 2pD"
echo "=============================================="
...
echo ""
echo "To stop: ./scripts/server/stop_1P_1D_2pD.sh"
echo "=============================================="

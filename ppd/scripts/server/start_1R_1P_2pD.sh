#!/bin/bash
# ============================================================================
# Start Script for vLLM Configuration: 1R_1P_2pD
#
# Architecture: 1P + 2pD + 1R
# 
#   GPU0: R (port 8300)
#   GPU1: P (port 8100)
#   GPU2: pD (port 8200)
...
LOG_DIR="$PROJECT_DIR/logs/1R_1P_2pD"
SRC_DIR="$PROJECT_DIR/src"
mkdir -p "$LOG_DIR"
rm -f "$LOG_DIR"/*.log 2>/dev/null || true

echo "=============================================="
echo "Starting vLLM Configuration: 1R_1P_2pD"
echo "Architecture: 1P + 2pD + 1R"
echo "=============================================="
...
echo ""
echo "=============================================="
echo "Configuration 1R_1P_2pD ready!"
echo "Architecture: 1P + 2pD + 1R"
echo "=============================================="
...
echo ""
echo "To stop: ./scripts/server/stop_1R_1P_2pD.sh"
echo "=============================================="

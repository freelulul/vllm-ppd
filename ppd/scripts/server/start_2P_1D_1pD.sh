#!/bin/bash
# ============================================================================
# Start Script for vLLM Configuration: 2P_1D_1pD
#
# Architecture: 2P + 1D + 1pD
# 
#   GPU0: P (port 8100)
#   GPU1: P (port 8101)
#   GPU2: D (port 8200)
...
LOG_DIR="$PROJECT_DIR/logs/2P_1D_1pD"
SRC_DIR="$PROJECT_DIR/src"
mkdir -p "$LOG_DIR"
rm -f "$LOG_DIR"/*.log 2>/dev/null || true

echo "=============================================="
echo "Starting vLLM Configuration: 2P_1D_1pD"
echo "Architecture: 2P + 1D + 1pD"
echo "=============================================="
...
echo ""
echo "=============================================="
echo "Configuration 2P_1D_1pD ready!"
echo "Architecture: 2P + 1D + 1pD"
echo "=============================================="
...
echo ""
echo "To stop: ./scripts/server/stop_2P_1D_1pD.sh"
echo "=============================================="

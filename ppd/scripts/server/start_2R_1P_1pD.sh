#!/bin/bash
# ============================================================================
# Start Script for vLLM Configuration: 2R_1P_1pD
#
# Architecture: 1P + 1pD + 2R
# 
#   GPU0: R (port 8300)
#   GPU1: R (port 8400)
#   GPU2: P (port 8100)
...
LOG_DIR="$PROJECT_DIR/logs/2R_1P_1pD"
SRC_DIR="$PROJECT_DIR/src"
mkdir -p "$LOG_DIR"
rm -f "$LOG_DIR"/*.log 2>/dev/null || true

echo "=============================================="
echo "Starting vLLM Configuration: 2R_1P_1pD"
echo "Architecture: 1P + 1pD + 2R"
echo "=============================================="
...
echo ""
echo "=============================================="
echo "Configuration 2R_1P_1pD ready!"
echo "Architecture: 1P + 1pD + 2R"
echo "=============================================="
...
echo ""
echo "To stop: ./scripts/server/stop_2R_1P_1pD.sh"
echo "=============================================="

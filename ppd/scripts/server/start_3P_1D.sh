#!/bin/bash
# ============================================================================
# Start Script for vLLM Configuration: 3P_1D
#
# Architecture: 3P + 1D
# 
#   GPU0: P (port 8100)
...
LOG_DIR="$PROJECT_DIR/logs/3P_1D"
SRC_DIR="$PROJECT_DIR/src"
mkdir -p "$LOG_DIR"
rm -f "$LOG_DIR"/*.log 2>/dev/null || true

echo "=============================================="
echo "Starting vLLM Configuration: 3P_1D"
echo "Architecture: 3P + 1D"
echo "=============================================="
...
echo ""
echo "=============================================="
echo "Configuration 3P_1D ready!"
echo "Architecture: 3P + 1D"
echo "=============================================="
...
echo ""
echo "To stop: ./scripts/server/stop_3P_1D.sh"
echo "=============================================="

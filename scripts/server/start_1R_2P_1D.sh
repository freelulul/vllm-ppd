#!/bin/bash
# ============================================================================
# Start Script for vLLM Configuration: 1R_2P_1D
#
# Architecture: 2P + 1D + 1R
# 
#   GPU0: R (port 8300)
#   GPU1: P (port 8100)
#   GPU2: P (port 8101)
...
echo "=============================================="
echo "Starting vLLM Configuration: 1R_2P_1D"
echo "Architecture: 2P + 1D + 1R"
echo "=============================================="
...
# Start Prefill (GPU 1)
echo "[3/5] Starting Prefill (GPU 1, port 8100)..."
...
# Start Prefill (GPU 2)
echo "[4/5] Starting Prefill (GPU 2, port 8101)..."
...
# Start Decode (GPU 3)
echo "[5/5] Starting Decode (GPU 3, port 8200)..."
KV_CONFIG='{"kv_connector":"P2pNcclConnector","kv_role":"kv_consumer","kv_buffer_size":10000000000,"kv_port":14581,"kv_connector_extra_config":{"proxy_ip":"0.0.0.0","proxy_port":"30001","http_port":"8200","send_type":"PUT_ASYNC"}}'
...
echo ""
echo "=============================================="
echo "Configuration 1R_2P_1D ready!"
echo "Architecture: 2P + 1D + 1R"
echo "=============================================="
echo "R: http://localhost:8300 (GPU 0)"
echo "P: http://localhost:8100 (GPU 1)"
echo "P: http://localhost:8101 (GPU 2)"
echo "D: http://localhost:8200 (GPU 3)"
echo ""
echo "Proxy: http://localhost:$PROXY_PORT"
echo ""
echo "To stop: ./scripts/server/stop_1R_2P_1D.sh"
echo "=============================================="

#!/bin/bash
# ============================================================================
# Start Script for vLLM Configuration: 1R_2P_1pD
#
# Architecture: 2P + 1pD + 1R
# 
#   GPU0: R (port 8300)
#   GPU1: P (port 8100)
#   GPU2: P (port 8101)
...
LOG_DIR="$PROJECT_DIR/logs/1R_2P_1pD"
SRC_DIR="$PROJECT_DIR/ppd"
mkdir -p "$LOG_DIR"
rm -f "$LOG_DIR"/*.log 2>/dev/null || true

echo "=============================================="
echo "Starting vLLM Configuration: 1R_2P_1pD"
echo "Architecture: 2P + 1pD + 1R"
echo "=============================================="
...
echo ""
echo "=============================================="
echo "Configuration 1R_2P_1pD ready!"
echo "Architecture: 2P + 1pD + 1R"
echo "=============================================="
...
echo ""
echo "To stop: ./scripts/server/stop_1R_2P_1pD.sh"
echo "=============================================="
